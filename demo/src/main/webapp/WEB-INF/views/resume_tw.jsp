        ...
        <div class="spin-body-wrapper">
            <div class="spin-left col-left">
                <div class="spin-left-1">
                    <p class="spin-content-1">研究所期間利用 Java 撰寫程式進行論文的數值分析研究一年, 工作上從事維護與開發網站程式設計近七年。 Java-based 網站有四年的經歷, PHP-based 網站有兩年多的經歷。 平常喜歡學習並補強技術, 對於程式設計有極大熱情。 喜歡不斷地改善程式提升穩定度以及想辦法提升開發效率。</p>
                </div>
